...
contains
  ...
  real function averageflux(u,w,c)
    ...
    ! U1/U0=4\beta/3+O(\beta^3)    ------->irrelativistic limit
                                   !relativistic limit: 3\beta/2-\beta^2/2
    ! T11=\rho(4\gamma^2\beta^2+1)/3=U1^2/U0+p+O(beta^3)   ????? =3/4*U1^2/U0+p+O(beta^3)
